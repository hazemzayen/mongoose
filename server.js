...
//Create Many Records 
const arrayOfPeople=[
    {name :'mohsen',email:'mohsen@gmail.com',age:40,favoriteFoods:['lasagne','makloub']},
    {name :'ahlem',email:'ahlem@gmail.com',age:30,favoriteFoods:['mlewi','mhames']},
    
    {name :'mohamedali',email:'mohamedali@gmail.com',age:20,favoriteFoods:['makloub','pizza']}
];
